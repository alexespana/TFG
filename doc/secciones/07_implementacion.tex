...
Procedamos a explicar la implementación necesaria para esta página de logs:
    ...
    \end{minted}
        ...
        de la función \textbf{open} de Python para abrir el archivo de logs y procesarlo
        línea por línea, creando una lista que luego será enviada como un parámetro al
        template. Un ejemplo de la vista de logs es el siguiente:
