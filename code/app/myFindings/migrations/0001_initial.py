    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('n_excavacion', models.CharField(help_text='Ej. 1, 2, 3, etc', max_length=3, unique=True, validators=[myFindings.models.validate_number], verbose_name='Número de excavación')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('n_estancia', models.CharField(help_text='Ej. 1, 2, 3, etc', max_length=3, unique=True, validators=[myFindings.models.validate_number], verbose_name='Número de estancia')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('n_orden', models.CharField(help_text='Ej. 1, 2, 3, etc', max_length=3, validators=[myFindings.models.validate_number], verbose_name='Número de orden')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(blank=True, choices=[('Positiva', 'Positiva'), ('Negativa', 'Negativa')], max_length=8, null=True)),
